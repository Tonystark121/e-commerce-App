...
import { getCartItems, deleteFromCart } from "../../redux/cartSlice";
...
const CartPage = () => {
  ...
  useEffect(() => {
    const total = items.reduce((sum, ele) => sum + parseInt(ele.price), 0);
    setAmount(total)
  }, [items]);

  useEffect(()=>{
    const num = Math.floor(Math.random() * 10);
    setDiscountAmount(Math.floor((amount * num)/100))
  },[amount])
  ...
  const deleteFromcart = (id) => {
    console.log('runnig the delete dx', id)
          ...
          <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
            ...
            >
              ...
              <ul role="list" className="divide-y divide-gray-200">
                      ...
                      <div className="mb-2 flex">
                        ...
                        <div className="ml-6 flex text-sm">
                          <button
                            ...
                            onClick={()=>deleteFromcart(product.docId)}
                          >
                ...
                {items.length <= 0 && (
                  <div className="container p-10 rounded">
                    <img
                      src="https://cdn-icons-png.flaticon.com/128/10437/10437090.png"
                      alt="Logo"
                      className="m-auto"
                    />
                    <h1 className="text-gray-400 text-center text-xl my-4">
                      Nothing to show in Cart Found
                    </h1>
                  </div>
                )}
              </ul>
                ...
                <dl className=" space-y-1 px-2 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">
                      ...
                      {items.length <= 0 && <p>Add items to cart</p>}
                    </dd>
                  </div>
